package dev.sts15.fargos.client.particle;
...
public class DeathSickleParticle extends TextureSheetParticle {
    ...
    protected DeathSickleParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
