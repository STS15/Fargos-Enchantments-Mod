...
public class DeathSickleRenderer extends GeoEntityRenderer<DeathSickleEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(DeathSickleEntity instance) {
        return new ResourceLocation(Fargos.MODID, "textures/entity/death_sickle_texture.png");
    }

    @Override
    public RenderType getRenderType(DeathSickleEntity animatable, float partialTicks, PoseStack stack,
