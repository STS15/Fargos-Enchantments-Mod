...
public class AbominationnsCurse extends Item {
    private final RegistryObject<EntityType<AbominationnEntity>> entityType;

    public AbominationnsCurse(RegistryObject<EntityType<AbominationnEntity>> abominmationn, Properties properties) {
        super(properties);
        this.entityType = abominmationn;
    }
