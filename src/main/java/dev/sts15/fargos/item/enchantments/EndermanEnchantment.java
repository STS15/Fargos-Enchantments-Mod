...
public class EndermanEnchantment extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.literal("Passive: Prevents Endermen aggression").withStyle(ChatFormatting.GRAY));
    }
