...
public class ArcticEnchantment extends Item implements ICurioItem {
	
	private final Random random = new Random();

    public ArcticEnchantment() {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.literal("Passive: Grants resistance to freezing effects").withStyle(ChatFormatting.GRAY));
    }
