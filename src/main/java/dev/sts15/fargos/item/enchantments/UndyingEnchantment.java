...
public class UndyingEnchantment extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.literal("Passive: Revives the player once upon death with full health").withStyle(ChatFormatting.GRAY));
    }
